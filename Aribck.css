...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'Konu Başlığı';
   var tocTool1 = 'Click to sort by title';
   var tocHead2 = 'tarih';
   var tocTool2 = 'Click to sort by date';
   var tocHead3 = 'Bölümler';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note"> konu sayısı ' + postTitle.length + ' Tema<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">konu sayısı ' + numDisplayed + ' Bölümü \'';
      tocNote += postFilter + '\' *** '+ postTitle.length + ' toplam konu sayısı<br/></span>';
   }
